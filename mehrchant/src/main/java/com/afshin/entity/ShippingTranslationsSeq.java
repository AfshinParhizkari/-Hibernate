...
@Entity
@Table(name = "SHIPPING_TRANSLATIONS_SEQ", schema = "FusionOrderDemo", catalog = "")
public class ShippingTranslationsSeq {
    ...
    public boolean equals(Object o) {
        ...
        ShippingTranslationsSeq that = (ShippingTranslationsSeq) o;
