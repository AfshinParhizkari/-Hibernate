...
@Entity
@Table(name = "ORDER_SEQ", schema = "FusionOrderDemo", catalog = "")
public class OrderSeq {
    ...
    public boolean equals(Object o) {
        ...
        OrderSeq orderSeq = (OrderSeq) o;

        if (nextNotCachedValue != null ? !nextNotCachedValue.equals(orderSeq.nextNotCachedValue) : orderSeq.nextNotCachedValue != null)
            return false;
        if (minimumValue != null ? !minimumValue.equals(orderSeq.minimumValue) : orderSeq.minimumValue != null)
            return false;
        if (maximumValue != null ? !maximumValue.equals(orderSeq.maximumValue) : orderSeq.maximumValue != null)
            return false;
        if (startValue != null ? !startValue.equals(orderSeq.startValue) : orderSeq.startValue != null) return false;
        if (increment != null ? !increment.equals(orderSeq.increment) : orderSeq.increment != null) return false;
        if (cacheSize != null ? !cacheSize.equals(orderSeq.cacheSize) : orderSeq.cacheSize != null) return false;
        if (cycleOption != null ? !cycleOption.equals(orderSeq.cycleOption) : orderSeq.cycleOption != null)
            return false;
        if (cycleCount != null ? !cycleCount.equals(orderSeq.cycleCount) : orderSeq.cycleCount != null) return false;
