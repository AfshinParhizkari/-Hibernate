...
@Entity
@Table(name = "PERSON_SEQ", schema = "FusionOrderDemo", catalog = "")
public class PersonSeq {
    ...
    public boolean equals(Object o) {
        ...
        PersonSeq personSeq = (PersonSeq) o;

        if (nextNotCachedValue != null ? !nextNotCachedValue.equals(personSeq.nextNotCachedValue) : personSeq.nextNotCachedValue != null)
            return false;
        if (minimumValue != null ? !minimumValue.equals(personSeq.minimumValue) : personSeq.minimumValue != null)
            return false;
        if (maximumValue != null ? !maximumValue.equals(personSeq.maximumValue) : personSeq.maximumValue != null)
            return false;
        if (startValue != null ? !startValue.equals(personSeq.startValue) : personSeq.startValue != null) return false;
        if (increment != null ? !increment.equals(personSeq.increment) : personSeq.increment != null) return false;
        if (cacheSize != null ? !cacheSize.equals(personSeq.cacheSize) : personSeq.cacheSize != null) return false;
        if (cycleOption != null ? !cycleOption.equals(personSeq.cycleOption) : personSeq.cycleOption != null)
            return false;
        if (cycleCount != null ? !cycleCount.equals(personSeq.cycleCount) : personSeq.cycleCount != null) return false;
