...
@Entity
@Table(name = "DISCOUNT_TRANSLATIONS_SEQ", schema = "FusionOrderDemo", catalog = "")
public class DiscountTranslationsSeq {
    ...
    public boolean equals(Object o) {
        ...
        DiscountTranslationsSeq that = (DiscountTranslationsSeq) o;
