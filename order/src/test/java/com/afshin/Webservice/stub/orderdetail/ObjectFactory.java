 ...
 * generated in the com.afshin.Webservice.stub.orderdetail package. 
...
public class ObjectFactory {
    ...
    private final static QName _OrderdetailPKXML_QNAME = new QName("http://Webservice.afshin.com/", "OrderdetailPKXML");
    private final static QName _OrderdetailXML_QNAME = new QName("http://Webservice.afshin.com/", "OrderdetailXML");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.afshin.Webservice.stub.orderdetail
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://Webservice.afshin.com/", name = "OrderdetailPKXML")
     ...
     */
    @XmlElementDecl(namespace = "http://Webservice.afshin.com/", name = "OrderdetailXML")
