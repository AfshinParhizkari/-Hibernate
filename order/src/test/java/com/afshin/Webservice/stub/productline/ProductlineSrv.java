 ...
 * 
 */
@WebServiceClient(name = "ProductlineSrv", targetNamespace = "http://Webservice.afshin.com/", wsdlLocation = "http://localhost:8080/order/soap/productline?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTLINESRV_QNAME = new QName("http://Webservice.afshin.com/", "ProductlineSrv");
    ...
    public ProductlineInt getProductlineIntPort() {
        return super.getPort(new QName("http://Webservice.afshin.com/", "ProductlineIntPort"), ProductlineInt.class);
    }
    ...
    public ProductlineInt getProductlineIntPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Webservice.afshin.com/", "ProductlineIntPort"), ProductlineInt.class, features);
    }
