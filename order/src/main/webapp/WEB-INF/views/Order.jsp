...
<c:if test="${requestScope.message ne null}">
    ...
    <c:if test="${requestScope.orders ne null}">
        <c:forEach var="order" items="${requestScope.orders}">
            ...
            <tr>
                <td><a href="${pageContext.request.contextPath}/api/OrderdetailAct?ordernum=${order.orderNumber}&crud=factor"><c:out value="${order.orderNumber}"></c:out></a></td>
                ...
                <td><a href="${pageContext.request.contextPath}/api/OrderAct?onum=${order.orderNumber}&crud=edit">edit</a></td>
                <td><a href="${pageContext.request.contextPath}/api/OrderAct?onum=${order.orderNumber}&crud=delete">delete</a></td>
            </tr>
            </c:if>
        </c:forEach>
    </c:if>
