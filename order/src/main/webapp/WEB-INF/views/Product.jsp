...
<table border="1px">
    ...
    <c:if test="${requestScope.products !=null}">
        <c:forEach var="product" items="${requestScope.products}">
           ...
           <td><a href="${pageContext.request.contextPath}/api/ProductAct?proNum=${product.productCode}&crud=edit">edit</a></td>
           <td><a href="${pageContext.request.contextPath}/api/ProductAct?proNum=${product.productCode}&crud=delete">delete</a></td>
           </tr>
            </c:if>
        </c:forEach>
    </c:if>
